    ...
    for (uint64_t i = 0; i < LoadPerThread; i++) {
        switch (idx % 8) {
            case 0:
                ...
                amb.byte0.fetch_sub(1);
                break;
            case 1:
                amb.byte1.fetch_add(1);
                amb.byte1.fetch_sub(1);
                break;
            case 2:
                amb.byte2.fetch_add(1);
                amb.byte2.fetch_sub(1);
                break;
            case 3:
                amb.byte3.fetch_add(1);
                amb.byte3.fetch_sub(1);
                break;
            case 4:
                amb.byte4.fetch_add(1);
                amb.byte4.fetch_sub(1);
                break;
            case 5:
                amb.byte5.fetch_add(1);
                amb.byte5.fetch_sub(1);
                break;
            case 6:
                amb.byte6.fetch_add(1);
                amb.byte6.fetch_sub(1);
                break;
            case 7:
                amb.byte7.fetch_add(1);
                amb.byte7.fetch_sub(1);
                break;
            default:
                return;
        }
