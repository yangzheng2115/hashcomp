//
// Created by yangzheng on 2019/11/19.
//

#ifndef HASHCOMP_CONCURRENT_RECOVERY_TEST_H
#define HASHCOMP_CONCURRENT_RECOVERY_TEST_H
...
namespace sum_store {
    ...
    public:
        ...
        void RecoverAndTest(const Guid& index_token, const Guid& hybrid_log_token) {
            ...
            Status result = store.Recover(index_token, hybrid_log_token, version,
                                                        session_ids);
            if(result != Status::Ok) {
...
#endif //HASHCOMP_CONCURRENT_RECOVERY_TEST_H
